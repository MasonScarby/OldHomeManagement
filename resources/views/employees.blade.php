...
<div class="container">
    ...
    <tr>
        <td>{{ $employee->id }}</td>
        <td>{{ $employee->user->first_name }} {{ $employee->user->last_name }}</td> <!-- Access user relation -->
    ...
    @endforeach
        ...
        <!-- if the current user is supervisor and if the user is admin then send variable called like current user to grab the current user -->
